...
//    echo htmlspecialchars($_POST['ingredients']);
    ...
    if(empty($_POST['title'])){
        ...
        $title = $_POST['title'];
        if (!preg_match('/^[a-zA-Z\s]+$/', $title)) { //^ - from the start +$ - till the end
...
<section class="container grey-text">
    ...
    <form class="white" action="add.php" method="POST">
        ...
        <input type="text" name="ingredients" value="<?php if(isset($ingredients)) { echo htmlspecialchars($ingredients); } ?>">
